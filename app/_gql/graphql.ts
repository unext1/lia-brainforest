...
export type CreateWorkplaceMutation = { insertLiaWorkplace?: { affected_rows: number, returning: Array<{ id: string, title?: string | null, url: string, ownerId: string, updatedAt: string }> } | null };
...
export type GetWorkplacesQuery = { liaWorkplace: Array<{ title?: string | null, token: string, url: string, ownerId: string, id: string, updatedAt: string }> };
