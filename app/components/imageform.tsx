    ...
    <>
      <div className="grid gap-5 2xl:grid-cols-2">
        <div className="flex flex-col">
          <label
            htmlFor="title"
            className="mb-2 font-semibold tracking-wider uppercase text-s"
          >
            Wordpress title
          </label>
          <textarea
      ...
      <button
        ...
        className=" w-fit  sm:px-12 sm:py-2.5 mx-auto mt-6  text-xs px-6 py-1.5 md:text-sm font-bold text-white uppercase bg-red-500 rounded-lg"
      >
